...
func buildAIDoc() string {
	lines := []string{
		...
		"## Plugin Authoring",
		"",
		"APIShark aggregation plugins are ESM modules. A JavaScript plugin must export:",
		"",
		"- `id`: lowercase plugin id, for example `vendor.profile`",
		"- `label`: human-readable name",
		"- `description`: optional description",
		"- `create()`: factory returning an object with optional lifecycle methods",
		"",
		"Allowed lifecycle methods on the plugin instance:",
		"",
		"- `init()`",
		"- `onRawEvent(event)`",
		...
		"- `finalize()`",
		"",
		"Each method may return either nothing or an update object shaped like:",
		"",
		"```js",
		"{",
		`  append: [{ kind: "text", text: "..." }],`,
		`  replace: [{ kind: "text", text: "..." }]`,
		"}",
		"```",
		"",
		...
		`export const description = "Echoes SSE payloads into the aggregate pane.";`,
		"",
		...
		"      }",
		"      return {",
		`        append: [{ kind: "text", text: event.sseData + "\n" }],`,
		"      };",
		"    },",
		"  };",
		"}",
